    ...
    */
    ...
    function init() {
        ...
        document.onkeydown = function (e) {
            if (typeof (fuinput) == 'function') fuinput();
            keyDown(e);
        }
        ...
        var tt = {
            af: [0x3b, 0xbb], ag: [0x3b, 0xbb],   // fire x2

Input = (function () {
    ...
    var leftpressed = false, rightpressed = false, uppressed = false, downpressed = false, f1pressed = false,
        firepressed = false, minuspressed, pluspressed, f10pressed, escape = false;
    ...
    return {
        ...
        firepressed_w: function (x) {
            firepressed = x;
        },
        keypressed_r: function () {
            return keypressed;
        },
        keypressed_w: function (x) {
            keypressed = x;
        },
        akeypressed_r: function () {
            return akeypressed;
        },
        akeypressed_w: function (x) {
            akeypressed = x;
        },
        escape_r: function () {
            return escape;
